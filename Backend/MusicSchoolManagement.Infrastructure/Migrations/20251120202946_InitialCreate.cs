        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuitableInstruments = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonsPerMonth = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParentPhone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParentEmail = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Biography = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AvailabilityNotes = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalLessons = table.Column<int>(type: "int", nullable: false),
                    UsedLessons = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentPackages_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Appointments_Classrooms_ClassroomId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_StudentPackages_StudentPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_StudentPackages_StudentPackageId",
                        column: x => x.StudentPackageId,
                        principalTable: "StudentPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceLogs_Appointments_AppointmentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceLogs_Users_RecordedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ClassroomId_AppointmentDate",
                table: "Appointments",
                columns: new[] { "ClassroomId", "AppointmentDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StudentId_AppointmentDate",
                table: "Appointments",
                columns: new[] { "StudentId", "AppointmentDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StudentPackageId",
                table: "Appointments",
                column: "StudentPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_TeacherId_AppointmentDate",
                table: "Appointments",
                columns: new[] { "TeacherId", "AppointmentDate" });

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLogs_AppointmentId",
                table: "AttendanceLogs",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLogs_RecordedBy",
                table: "AttendanceLogs",
                column: "RecordedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_StudentPackageId",
                table: "Payments",
                column: "StudentPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPackages_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPackages_StudentId_CourseId_Status",
                table: "StudentPackages",
